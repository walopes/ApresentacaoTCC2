...
\title[Short title]{Projeto e implementação de \\robô autônomo seguidor de linha} % The short title appears at the bottom of every slide, the full title is only on the title page

\author{Willian Americano Lopes} % Your name
...
\medskip
%\textit{walopes23@gmail.com} % Your email address
...
%\titlegraphic{\includegraphics[scale=0.5]{utf2.pdf}}
\titlegraphic{}
...
\setbeamertemplate{background}{%
  \raisebox{-0.65cm}{%
    \parbox[c]{2.8cm}{\centering%
      \includegraphics[width=2cm]{utf.pdf}%
    }%
